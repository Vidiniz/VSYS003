object FrmOrderSale: TFrmOrderSale
  ...
  object PgCtrlMain: TPageControl
    ...
    object TbShtRegister: TTabSheet
      ...
      object PnlRegisterHeader: TPanel
        ...
        object LblRegHeaderBranch: TLabel
          Left = 558
          Top = 22
          Width = 20
          Height = 13
        ...
        object CmbBxRegHeaderBranch: TComboBox
          Left = 558
          Top = 37
          Width = 115
          Height = 22
        ...
        object DtTmPckRegHeaderDate: TDateTimePicker
          ...
          Height = 22
          Anchors = [akTop, akRight]
          Date = 43147.749575717590000000
          Time = 43147.749575717590000000
          TabOrder = 4
          OnClick = DtTmPckRegHeaderDateClick
          OnExit = DtTmPckRegHeaderDateExit
        end
        object CmbBxRegHeaderPayPlan: TComboBox
          Left = 374
          Top = 37
          Width = 178
          Height = 22
      ...
      object PnlRegSearchProd: TPanel
        ...
        object LblSearchProdProvider: TLabel
          Left = 432
          Top = 0
          Width = 55
          Height = 13
        ...
        object LblSearchProdDepart: TLabel
          Left = 567
          Top = 0
          Width = 69
          Height = 13
        ...
        object CmbBxSearchProdProvider: TComboBox
          Left = 432
          Top = 15
          Width = 129
          Height = 22
        ...
        object CmbBxSearchProdDepart: TComboBox
          Left = 567
          Top = 15
          Width = 125
          Height = 22
  ...
  object ImgLstOrderSale: TImageList
    Left = 616
    Bitmap = {
      494C01010A003800400010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
